  ...
  return {
    ...
    included: {
      ...
      items: [
        ...
        "4–6 use cases ranked by estimated impact",
    ...
    trust: {
      ...
      body: "We're not going to manufacture a project that isn't there. In 90 minutes I'll tell you plainly what's worth fixing — and if the honest answer is 'not much yet,' that's what you'll hear instead of a pitch. The 90 minutes and the map are yours either way.",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: `That's what Phase 1 is for — done-for-you implementation of the highest-impact use case from your map. Typically ${phase1Anchor}, 2–3 weeks. If you want to proceed, I'll quote it. If you don't, the map and the clarity are yours either way.`,
        },
        {
          q: "How is this different from a consultancy deck, a ChatGPT demo, or hiring a consultant?",
          a: "A consultancy takes 6–8 weeks and a large fee, and gives you a presentation. A ChatGPT demo is free and gives you vague excitement. Hiring a consultant means a proposal, a retainer, and months of onboarding. This is 90 minutes and gives you a scored, ranked map of your own business — and you decide what to do with it.",
        },
        {
          q: "What if my business is too unique for AI?",
          a: "Most founders think this. After 90 minutes you'll know specifically which parts of your business AI can touch — and which it genuinely can't. Sometimes the answer is 'almost none of it yet' — and that's a useful answer worth having.",
        },
        {
          q: "What does the map actually look like?",
          a: "A one-page scored document: your business broken into pain points, each scored for AI feasibility and estimated impact. You leave with 4–6 ranked use cases and a clear Phase 1 recommendation — or an honest 'not yet' if nothing clears the bar.",
        },
        {
          q: "Who is this for?",
  ...
  return {
    ...
    included: {
      ...
      items: [
        ...
        "4–6 casos de uso priorizados por impacto estimado",
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: `Para eso está la Fase 1 — implementación llave en mano del caso de mayor impacto de tu mapa. Normalmente ${phase1Anchor}, 2–3 semanas. Si quieres seguir adelante, te lo presupuesto. Si no, el mapa y la claridad son tuyos de todas formas.`,
        },
        {
          q: "¿En qué se diferencia de una consultora, una demo de ChatGPT o contratar a un consultor?",
          a: "Una consultora tarda 6–8 semanas, cuesta mucho y te da una presentación. Una demo de ChatGPT es gratis y te da entusiasmo vago. Contratar a un consultor implica propuesta, permanencia y meses de onboarding. Esto son 90 minutos y te da un mapa priorizado de tu propio negocio — y tú decides qué hacer con él.",
        },
        {
        ...
        },
        {
          ...
          a: "Un documento de una página, priorizado: tu negocio dividido en puntos de dolor, cada uno puntuado por viabilidad de IA e impacto estimado. Te vas con 4–6 casos de uso priorizados y una recomendación clara de Fase 1 — o un honesto 'todavía no' si nada lo justifica.",
        },
        {
          q: "¿Para quién es esto?",
          a: "Para ti si tienes suficientes enquiries, llamadas, presupuestos o admin como para que tiempo y dinero de verdad desaparezcan en trabajo repetitivo cada semana. No es para ti si cada decisión necesita seis personas, o si buscas una herramienta y no una solución.",
        },
        {
