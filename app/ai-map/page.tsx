...
export const metadata: Metadata = {
  ...
  description:
    "A 90-minute working session that maps every AI opportunity in your business, ranked by ROI. One-page document delivered within 48 hours. Complimentary until June 15.",
  ...
  openGraph: {
    ...
    description:
      "Find where AI pays off in your business. One-page map, delivered within 48h. Complimentary until June 15. 10× value guarantee.",
  ...
  twitter: {
    ...
    title: "Strategic AI Map — 90 minutes, ROI-ranked",
    description: "Complimentary until June 15. 10× value guarantee.",
  },
};
