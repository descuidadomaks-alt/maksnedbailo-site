        ...
        <div data-reveal className="relative w-full rounded-2xl border border-white/[0.06] overflow-hidden" style={{ background: "rgba(255,255,255,0.012)" }}>
          ...
          <div ref={scrollRef} className="overflow-x-auto" style={{ WebkitOverflowScrolling: "touch" }}>
            <div style={{ minWidth: "580px" }}>
              <div className="grid px-6 py-3 border-b border-white/[0.05] gap-4" style={{ gridTemplateColumns: "1.2fr 1fr 1fr" }}>
              ...
              {rows.map(([useCase, pain, result], i) => (
                <div key={i} className="grid px-6 py-5 border-t border-white/[0.04] hover:bg-white/[0.016] transition-colors duration-150 items-start gap-4" style={{ gridTemplateColumns: "1.2fr 1fr 1fr" }}>
