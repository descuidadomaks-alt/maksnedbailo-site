...
const copy = {
  en: {
    ...
    aside: "My product/design brain started collecting tiny notes from the website — a few mobile friction points, some English gaps, a logo asset that probably wants its vector file back, and a first-contact experience that could perhaps demonstrate more of what NetBees actually does.",
  ...
  es: {
    ...
    aside: "Mi cerebro de producto/diseño empezó a apuntar pequeñas cosas de la web: algunos detalles de fricción en móvil, partes en inglés que se quedan a medio camino, un logo que probablemente echa de menos su archivo vectorial y una primera interacción que quizá podría mostrar un poco mejor lo que NetBees sabe hacer.",
