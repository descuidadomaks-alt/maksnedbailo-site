/**
 * Overtime OS. — oos landing page constants. Renamed from "Overtime Hunch"
 ...
 *
 * oos is oh3 re-gated for the Carter ad campaign: the demo video is now
...
// Carter's closer calendar. Shown after the form is submitted (VideoForm's
// "Book your call" CTA, the "Grab a time now" follow-up link, and the quiz
// success screen's "Skip ahead — book your free call" link).
export const BOOKING_LINK = "https://calendly.com/cartersmalley/overtimeos";

// Self-hosted demo video — native <video>, no iframe/YouTube. Gated behind
// the form until submit (see VideoForm.tsx). Files live in
// public/projects/oos/ (compressed to 720p, faststart).
export const VIDEO_SRC = "/projects/oos/demo.mp4";
export const VIDEO_POSTER = "/projects/oos/demo-poster.jpg";
