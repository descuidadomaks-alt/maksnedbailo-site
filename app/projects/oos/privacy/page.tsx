...
/**
 * Minimal privacy-policy stub for Facebook ad review — links from the oos
 * footer. Scoped under /projects/oos so it inherits the oh-scope styling
 * from ../layout.tsx.
 */
    ...
    <main className="mx-auto max-w-2xl px-5 py-24">
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-[#171e19]/80">
        <p>
          ...
          our AI operating system for home-service businesses. This policy explains what information
