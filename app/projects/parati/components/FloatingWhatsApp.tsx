...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className={`pt-fab fixed z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gold text-ivory shadow-soft transition-all duration-500 hover:bg-gold-deep ${
