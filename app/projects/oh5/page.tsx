...
/**
 * oh5 — /projects/oh3 re-gated for the Carter ad campaign, since rebuilt
 ...
 * hero → video+form (gated demo, book-a-call) → value stack → app-comparison
 * → old/new way (+ anti-GHL row) → tiers → guarantee close.
 *
 * oh5 repositions the offer from "AI receptionist" to "managed AI front
 * office" — see components/AppComparison.tsx for the anchor-reset section
 * that sits right after the value stack.
 *
 ...
 */
export default function Oh5Page() {
  return (
    <LocationProvider>
      <QuizProvider>
        <Nav />
