...
/**
 * oh6 — /projects/oh3 re-gated for the Carter ad campaign, since rebuilt
 ...
 *
 * oh6 repositions the offer from "AI receptionist" to "managed AI front
 ...
 */
export default function Oh6Page() {
  return (
    <LocationProvider>
      <QuizProvider>
        <Nav />
