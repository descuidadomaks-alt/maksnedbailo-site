...
type TierItem = string | { text: string; sub: string };
...
const TIERS: Tier[] = [
  {
    ...
    items: [
      ...
      "24/7 AI office — answers calls, texts & website chat",
      "Emergency Triage — books real jobs, filters tire-kickers",
      "Instant reply + 3–5 touch follow-up",
      { text: "Google 5-star review engine", sub: GEO_BENEFIT },
      "Missed-call text-back",
      "Leads pushed straight to your phone",
      "Built, run & tuned for you — you never touch a dashboard",
    ],
  ...
  },
  {
    ...
    items: [
      ...
      "AI office on your site, socials + SMS",
    ...
    <section className="bg-white py-16 sm:py-24">
      <div className="mx-auto max-w-6xl px-5">
        ...
        <p className="mx-auto mt-4 max-w-xl text-center text-lg text-[#171e19]/70">
          One operating system. Start with the front office, add leads and visibility as
          you scale.
        </p>
