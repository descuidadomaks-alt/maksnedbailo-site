...
/**
 * Overtime OS. — oh6 variant, self-contained paid-ad landing under
 * /projects/oh6. Renamed from "Overtime Hunch" (oh4 and earlier keep the old
 ...
 * Pixel. Self-hosted video lives at public/projects/oh6/demo.mp4.
 *
...
export default function Oh6Layout({ children }: { children: ReactNode }) {
  return (
