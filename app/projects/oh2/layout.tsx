...
/**
 * Overtime Hunch. — oh2 variant, self-contained paid-ad landing under
 * /projects/oh2. Parallel to /projects/overtimehunch (untouched original);
 * this build sells the $499/mo AI-front-desk offer instead of ads-included.
 *
...
export default function Oh2Layout({ children }: { children: ReactNode }) {
  return (
