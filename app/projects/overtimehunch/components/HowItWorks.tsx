...
const STEPS = [
  {
    ...
    body: "Local ads bring in homeowners who want your service now.",
  },
  {
    n: "2",
    title: "Our AI answers & books.",
    body: "Every lead replied to in seconds, qualified, and booked on your calendar.",
  },
  {
    n: "3",
    title: "You show up & close.",
    body: "Walk into pre-qualified, booked jobs. No chasing. No admin.",
  },
];
