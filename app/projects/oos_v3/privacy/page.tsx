...
/** Minimal privacy stub, forked from the sibling pages' privacy/page.tsx. */
  ...
  return (
    <main className="mx-auto max-w-2xl px-5 py-24">
      ...
      <div className="mt-8 space-y-6 text-base leading-relaxed text-[#171e19]/80">
        <p>
          {BRAND} (&quot;we&quot;, &quot;us&quot;) operates this page as a landing page for our
          done-for-you AI front office for home-service businesses. This policy explains what
          information the free missed-call audit form on this page collects and how we use it.
        </p>

        <section>
          <h2 className="oh-display text-xl text-[#171e19]">What we collect</h2>
          <p className="mt-2">
            When you request the audit on this page, we collect your first name, business phone
            number, email address, and the trade you selected. We don&apos;t collect any other
            personal information through this page.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            We use your business phone number to call it after hours and record what a customer
            hears, then send you that recording. We use your name and email to send you the
            recording and follow up about the audit. We don&apos;t sell your information, and we
        ...
        <section>
          ...
          <p className="mt-2">
            If you check the consent box on the audit form, we may contact you by text or call —
