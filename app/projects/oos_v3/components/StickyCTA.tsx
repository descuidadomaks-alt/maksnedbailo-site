...
/**
 * Mobile-only sticky CTA, forked unchanged from
 * app/projects/oos/components/StickyCTA.tsx — appears once the visitor has
 * scrolled past the demo section.
 */
