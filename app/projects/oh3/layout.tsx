...
/**
 * Overtime Hunch. — oh3 variant, self-contained paid-ad landing under
 * /projects/oh3. Restructured copy of /projects/oh2 (both left untouched):
 * front-loads the $499/mo AI-front-desk offer and swaps the gated placeholder
 * demo for a real, self-hosted video (public/projects/oh3/demo.mp4).
 *
...
export default function Oh3Layout({ children }: { children: ReactNode }) {
  return (
