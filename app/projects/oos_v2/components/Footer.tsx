  ...
  return (
    <footer className="bg-[#171e19] pt-10 pb-28 text-center text-white/60 sm:pb-10">
      ...
      <p className="mt-4 flex items-center justify-center gap-3 px-5 text-[11px]">
        <a href="/projects/oos_v2/privacy" className="underline underline-offset-2 hover:text-white">
          Privacy Policy
        </a>
        <span className="text-white/30">·</span>
        <a href="/projects/oos_v2/terms" className="underline underline-offset-2 hover:text-white">
          Terms
        </a>
      </p>
    </footer>
