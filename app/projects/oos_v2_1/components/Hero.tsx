...
/**
 * Hero + demo video, merged into one section — same fold-fitting approach
...
// Highlighted phrase not specified in the brief — picked "More Jobs" as
// the concrete outcome, matching how the last two headlines each
// highlighted their own outcome phrase.
const HEADLINE =
