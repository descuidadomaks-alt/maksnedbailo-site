...
const MESSAGES: Record<"en" | "es", string[]> = {
  en: [
    "AVERAGE FOUNDER RESPONSE TIME: 4 TO 19 HOURS",
    ...
    "YOUOS IS THE REAL CEILING OF YOUR €1M TO €10M BUSINESS",
  ],
  es: [
    "TIEMPO MEDIO DE RESPUESTA DEL FUNDADOR: 4 A 19 HORAS",
    ...
    "YOUOS ES EL VERDADERO TECHO DE TU NEGOCIO DE 1M A 10M €",
  ],
};
