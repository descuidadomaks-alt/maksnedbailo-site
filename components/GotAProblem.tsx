    ...
    <section ref={ref} className="section-divider py-14 md:py-20">
      <div className="max-w-6xl mx-auto px-6">
        <div className="max-w-[640px]">
          ...
          >
            Got a different problem? I've probably solved one like it.
          </motion.h2>
          ...
          >
            Most businesses I work with have more than one bottleneck. Slow responses, leaking leads, manual booking, content backlog, support that doesn't scale — they all eat the same dollar.
          </motion.p>
          ...
          >
            Tell me what's broken. I'll tell you straight whether I can fix it, or who I'd send you to.
          </motion.p>
